...
public class StaffFragment extends Fragment implements Refreshable
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        Log.e("staff layout", ""+layout);
        this.page = new PageMeta("TabbedPanelsContentGroup", getString(R.string.staff_page_URL), layout);
